package Theory.Sesson11_Inheritance_version2.Craftsman;

import Theory.Sesson11_Inheritance_version2.Data.Rectangle;
import Theory.Sesson11_Inheritance_version2.Data.Circle;
import Theory.Sesson11_Inheritance_version2.Data.Square;
...
//        Square s1 = new Square("Chính", "Black", 5.0);
//        s1.paint();
        // Đây là lúc chưa sử dụng hàm được overive từ class cha
        // In ra |Rectangle |Chính          |     Black| 5,0| 5,0|  25,00| hoàn toàn đúng vì đang xài ké của Rectangle
        // Phải theo quy tắc của class CHA đặt ra, Rectangle in ra HCN, xài ké nên cũng phải in ra HCN
        Square s1 = new Square("Chính", "Black", 5.0);
        // Vuông là vuông
        s1.paint();
        // Vi diệu tập 1
        Rectangle r1 = new Rectangle("Hạnh", "pink", 7.0, 8.0);
        // Chữ nhật là chữ nhật
        r1.paint();
        // Vi diệu tập 2
        Rectangle s2 = new Square("An", "blue", 8.0);
        // Vuông là hình chữ nhật, hùa theo kế thừa dòng họ
        s2.paint(); // CON QUA MẶT CHA, ĐA HÌNH
        // HÀM PAINT CỦA CHA, NHƯNG OUTPUT: |Square   |An             |      blue| 8,0|  -  |  64,00|
