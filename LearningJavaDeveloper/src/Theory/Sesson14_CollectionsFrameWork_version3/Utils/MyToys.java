package Theory.Sesson14_CollectionsFrameWork_version3.Utils;
...
public class MyToys {
    ...
    public static void main(String[] args) {
        String id = getID("Input ID(ex: N19DCCN024): ", "Your input must be under "
