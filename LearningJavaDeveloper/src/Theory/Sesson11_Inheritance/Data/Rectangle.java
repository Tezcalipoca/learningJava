package Theory.Sesson11_Inheritance.Data;

// OOP: Object Oriented Programing/Paradigm
public class Rectangle {
    private String owner; //__________
    private String color; //__________
    private double width; //__________
    private double length; //__________
    private double area; //__________ width * length
